...
import { Main, MapRightSection, LocaleLeftSection, InputLocale, Form, Button, ResultContainer, SubTitle, LocaleContainer, ResultList, SearchContainer, DeleteText, BlurLimit } from "./components/Main_components/MainComponents";
